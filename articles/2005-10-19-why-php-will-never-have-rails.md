...
Despite Zend's annoucement of the [PHP Collaboration Project](http://www.zend.com/php-collaboration/), I believe PHP will never have a [Ruby On Rails](http://www.rubyonrails.com/) framework.

Sure, there are plenty of PHP frameworks — hell, [three](http://www.zend.com/php-collaboration/ "PHP Collaboration Project") [new](http://www.thinkcomputer.com/corporate/news/pressreleases.html?id=24 "Lampshade") [ones](http://www.symfony-project.com/ "Symfony Project") were announced this week–and it's only **Wednesday!** It's not that PHP will never have a framework that is similar to Rails; it's just that we'll never have one that unifies a group of developers in a similar fashion.
...
It's not that Rails is doing something that can't be done in PHP–I think most people reading this will be aware that MVC frameworks can be done in nearly any language, and [many](http://cakephp.org/ "Cake") [great](http://solarphp.com/ "SOLAR") [ones](http://www.phpwact.org/ "WACT") have already been done in PHP. It's that too many people using PHP are already doing their own thing. Coming out of obscurity with a small, unified approach is what has made Ruby On Rails work … and we're way past the obscurity point with PHP.
