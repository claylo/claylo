...
Like any other red-blooded, oxygen-breathing developer on Earth, I'd like [a free Sun Fire T2000](http://blogs.sun.com/roller/page/jonathan?entry=niagara_benchmarks), please.
...
While some [scary comments relating to installing PHP5 on Solaris](http://www.php.net/manual/en/install.unix.solaris.php) give me pause, they do not fill me with dread.

I have also read about how [Apache2 plus PHP5 with a threaded MPM is scary and ill-advised](http://www.php.net/manual/en/faq.installation.php#faq.installation.apache2). This also doesn't scare me, as I've read that PHP5 in a FastCGI configuration is fine in a threaded environment. Plus, I hear that [lighty](http://lighttpd.net/) plus PHP5 under FastCGI will smoke Apache2 any day, so I'm interested giving that a go as well.
...
With these goals in mind, and the confidence that I fit the profile of [someone eligible for the offer](http://blogs.sun.com/roller/page/jonathan?entry=niagara_free_trial_update) (I'm blogging *this*, right?), I filled out [the application on the Sun website](https://www.sun.com/secure/servers/coolthreads/tnb/qualify.jsp), which asks just a couple of questions. Here are the questions, and how I answered them in bold.
...
[![Technorati](http://killersoft.com/randomstrings/wp-content/plugins/UltimateTagWarrior/technoratiicon.jpg)](http://www.technorati.com/tag/) [niagra](http://www.technorati.com/tag/niagra), [php5](http://www.technorati.com/tag/php5), [solaris](http://www.technorati.com/tag/solaris), [t2000](http://www.technorati.com/tag/t2000)
